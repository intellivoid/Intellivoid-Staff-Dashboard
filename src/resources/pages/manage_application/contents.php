                                                ...
                                                <?PHP
                                                    switch($Application->Status)
                                                    {
                                                        case ApplicationStatus::Active:
                                                            ?>
                                                                <button class="btn btn-block btn-danger mt-3" onclick="location.href='<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'disable_application'), true); ?>'">Disable Application</button>
                                                            <?PHP
                                                            break;

                                                        case ApplicationStatus::Disabled:
                                                            ?>
                                                                <button class="btn btn-block btn-success mt-3" onclick="location.href='<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'enable_application'), true); ?>'">Enable Application</button>
                                                            <?PHP
                                                            break;
                                    ...
                                    <div class="col-12 grid-margin">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form method="POST" action="<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'update_verification_status'), true); ?>">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <?PHP
                                                    ...
                                                    {
                                                        ?>
                                                        <button type="button" class="btn btn-success btn-xs btn-block" onclick="location.href='<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'lift_suspension'), true); ?>';">Lift Suspension</button>
                                                        <?PHP
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <button type="button" class="btn btn-warning btn-xs btn-block" onclick="location.href='<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'suspend_application'), true); ?>';">Suspend</button>
                                                        <?PHP
                                                    }
                                                ?>
                                                <button type="button" class="btn btn-danger btn-xs btn-block" onclick="location.href='<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'delete_application'), true); ?>';">Delete</button>
                                                <button type="button" class="btn btn-outline-primary btn-xs btn-block">View Request Tokens</button>
                                                <button type="button" class="btn btn-outline-primary btn-xs btn-block">View Access Tokens</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8 grid-margin stretch-card">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="border-bottom" method="POST" action="<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'update_secret_key'), true) ?>">
                                            <div class="form-group pb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'update_authentication_mode'), true); ?>" method="POST">
                                        ...
                                        <form class="form-group pt-2" id="permissions-form" action="<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $_GET['id'], 'action' => 'update_permissions'), true); ?>" method="POST">
