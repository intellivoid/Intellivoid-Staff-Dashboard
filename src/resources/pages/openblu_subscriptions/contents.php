...
use OpenBlu\OpenBlu;
    ...
    $Results = get_results($OpenBlu->database, 5000, 'user_subscriptions', 'id',
        QueryBuilder::select(
...
<html lang="en">
    <head>
        ...
        <title>Intellivoid Staff - OpenBlu User Subscriptions</title>
    </head>
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-header header-sm d-flex justify-content-between align-items-center">
                                        <h4 class="card-title">OpenBlu Subscriptions</h4>
                                    </div>
                                    <div class="card-body">
                                        <?PHP
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu p-3">
                                                                            ...
                                                                            <div class="row ml-auto">
                                                                                <a href="<?PHP DynamicalWeb::getRoute('manage_account', array('id' => $subscription['account_id']), true) ?>" class="text-white pl-2">
                                                                ...
                                                                <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu p-3">
                                                                            ...
                                                                            <div class="border-top mt-3 mb-3"></div>
                                                                            <div class="row ml-auto">
                                                                                <a href="<?PHP DynamicalWeb::getRoute('view_access_record', array('id' => $subscription['access_record_id']), true) ?>" class="text-white pl-2">
                                                                                    <i class="mdi mdi-pencil"></i>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('manage_account', array('id' => $subscription['account_id']), true) ?>">Manage Account</a>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('view_access_record', array('id' => $subscription['access_record_id']), true) ?>">Manage Access Record</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <nav>
                                                                    <ul class="pagination flat pagination-success flex-wrap">
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            ?>
                                                                            <li class="page-item">
                                                                                <a class="page-link" href="<?PHP DynamicalWeb::getRoute('openblu_subscriptions', $RedirectHref, true); ?>">
                                                                                    <i class="mdi mdi-chevron-left"></i>
                                                                                </a>
                                                                            </li>
                                                                            <?PHP
                                                                        ...
                                                                        while(True)
                                                                        {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                ?>
                                                                                <li class="page-item">
                                                                                    <a class="page-link" href="<?PHP DynamicalWeb::getRoute('openblu_subscriptions', $RedirectHref, true); ?>"><?PHP HTML::print($current_count); ?></a>
                                                                                </li>
                                                                                <?PHP
                                                                            }
