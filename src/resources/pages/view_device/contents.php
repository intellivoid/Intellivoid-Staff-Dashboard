...
use IntellivoidAccounts\IntellivoidAccounts;
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('devices'));
    }
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('devices', array('callback' => '104')));
    }
    catch(Exception $exception)
    {
        Actions::redirect(DynamicalWeb::getRoute('devices', array('callback' => '105')));
    }
?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $Device->HostID), true); ?>">
