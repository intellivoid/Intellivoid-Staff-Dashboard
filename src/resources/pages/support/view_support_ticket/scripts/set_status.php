<?php
    ...
    function set_status()
    {
        ...
        switch(strtolower($_GET['status']))
        {
            ...
            default:
                Actions::redirect(
                    DynamicalWeb::getRoute('support/view_support_ticket', array('id' => $_GET['id'], 'callback' => '101'))
                );
                break;
        }
        ...
        {
            Actions::redirect(
                DynamicalWeb::getRoute('support/view_support_ticket', array('id' => $_GET['id'], 'callback' => '100'))
            );
        }

        Actions::redirect(
            DynamicalWeb::getRoute('support/view_support_ticket', array('id' => $_GET['id']))
        );
    }