...
use IntellivoidAccounts\IntellivoidAccounts;
    ...
    catch (SubscriptionPromotionNotFoundException $e)
    {
        Actions::redirect(DynamicalWeb::getRoute(
                'finance_subscriptions/subscription_promotions', array('callback' => '104')
        ));
    }
    catch(Exception $e)
    {
        Actions::redirect(DynamicalWeb::getRoute(
            'finance_subscriptions/subscription_promotions', array('callback' => '105')
        ));
    }
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group pb-3">
                                            <label for="subscription_plan_id">
                                                ...
                                                <a href="<?PHP DynamicalWeb::getRoute('finance_subscriptions/manage_subscription_plan', array('id' => $SubscriptionPromotion->SubscriptionPlanID), true); ?>" class="text-white">
                            ...
                            <div class="col-md-6 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" id="details-form" name="details-form" action="<?PHP DynamicalWeb::getRoute('finance_subscriptions/manage_subscription_promotion', array('id' => $_GET['id'], 'action' => 'update_properties'), true); ?>">
                                            ...
                                            <div class="form-group pb-3">
                                                <label for="affiliation_account_id">
                                                    ...
                                                    <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_account', array('id' => $SubscriptionPromotion->AffiliationAccountID), true); ?>" class="text-white">
                                                        <i class="mdi mdi-database-search"></i>
                                                    </a>
                                                </label>
                                    ...
                                    <div class="card-footer">
                                        <div class="row align-items-center">
                                            <button class="btn btn-danger ml-auto mr-2" onclick="location.href='<?PHP DynamicalWeb::getRoute('finance_subscriptions/manage_subscription_promotion', array('id' => $_GET['id'], 'action' => 'delete'), true); ?>';">Delete</button>
