...
use IntellivoidAccounts\IntellivoidAccounts;
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('finance_subscriptions/subscription_plans'));
    }
    ...
    catch (SubscriptionPlanNotFoundException $e)
    {
        Actions::redirect(DynamicalWeb::getRoute(
                'finance_subscriptions/subscription_plans', array('callback' => '104')
        ));
    }
    catch(Exception $e)
    {
        Actions::redirect(DynamicalWeb::getRoute(
            'finance_subscriptions/subscription_plans', array('callback' => '105')
        ));
    }
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-12 grid-margin">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <button class="btn btn-block btn-outline-primary mt-3" onclick="location.href='<?PHP DynamicalWeb::getRoute('cloud/manage_application', array('id' => $Application->ID), true); ?>'">Manage Application</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 grid-margin">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form method="POST" action="<?PHP DynamicalWeb::getRoute('finance_subscriptions/manage_subscription_plan', array('id' => $_GET['id'], 'action' => 'update_status'), true); ?>">
                                    ...
                                    <div class="col-12 grid-margin">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <button type="button" class="btn btn-outline-primary btn-xs btn-block" onclick="location.href='<?PHP DynamicalWeb::getRoute('finance_subscriptions/subscription_promotions', array('filter' => 'subscription_plan_id', 'value' => $SubscriptionPlan->ID), true) ?>';">
                                                    <i class="mdi mdi-view-list"></i> View Promotions
                                                </button>
                                                <button type="button" class="btn btn-outline-primary btn-xs btn-block" onclick="location.href='<?PHP DynamicalWeb::getRoute('finance_subscriptions/manage_subscription_promotion', array('filter' => 'subscription_plan_id', 'value' => $SubscriptionPlan->ID), true) ?>';">
                            ...
                            <div class="col-md-8 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group pb-3">
                                            <label for="application_id">
                                                Application ID
                                                <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_application', array('id' => $SubscriptionPlan->ApplicationID), true); ?>" class="text-white">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" id="details-form" name="details-form" action="<?PHP DynamicalWeb::getRoute('finance_subscriptions/manage_subscription_plan', array('id' => $_GET['id'], 'action' => 'update_properties'), true); ?>">
