                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu p-3">
                                                                                ...
                                                                                <div class="row ml-auto">
                                                                                    <a href="<?PHP DynamicalWeb::getRoute('finance_subscriptions/manage_subscription_plan', array('id' => $subscription_promotion['subscription_plan_id']), true) ?>" class="text-white pl-2">
                                                                                        <i class="mdi mdi-database-search"></i>
                                                                                    </a>
                                                                                    <a href="<?PHP DynamicalWeb::getRoute('finance_subscriptions/subscription_promotions', array('filter' => 'subscription_plan_id', 'value' => $subscription_promotion['subscription_plan_id']), true) ?>" class="text-white pl-2">
                                                                                        <i class="mdi mdi-filter"></i>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu p-3">
                                                                                ...
                                                                                <div class="border-top mt-3 mb-3"></div>
                                                                                <div class="row ml-auto">
                                                                                    <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_account', array('id' => $subscription_promotion['affiliation_account_id']), true) ?>" class="text-white pl-2">
                                                                                        <i class="mdi mdi-database-search"></i>
                                                                                    </a>
                                                                                    <a href="<?PHP DynamicalWeb::getRoute('finance_subscriptions/subscription_promotions', array('filter' => 'affiliation_account_id', 'value' => $subscription_promotion['affiliation_account_id']), true) ?>" class="text-white pl-2">
                                                                                        <i class="mdi mdi-filter"></i>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('finance_subscriptions/manage_subscription_promotion', array('id' => $subscription_promotion['id']), true); ?>">Manage Promotion</a>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <nav>
                                                                    <ul class="pagination flat pagination-success flex-wrap">
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            ?>
                                                                            <li class="page-item">
                                                                                <a class="page-link" href="<?PHP DynamicalWeb::getRoute('finance_subscriptions/subscription_promotions', $RedirectHref, true); ?>">
                                                                                    <i class="mdi mdi-chevron-left"></i>
                                                                                </a>
                                                                            </li>
                                                                            <?PHP
                                                                        ...
                                                                        while(True)
                                                                        {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                ?>
                                                                                <li class="page-item">
                                                                                    <a class="page-link" href="<?PHP DynamicalWeb::getRoute('finance_subscriptions/subscription_promotions', $RedirectHref, true); ?>"><?PHP HTML::print($current_count); ?></a>
                                                                                </li>
                                                                                <?PHP
                                                                            }
