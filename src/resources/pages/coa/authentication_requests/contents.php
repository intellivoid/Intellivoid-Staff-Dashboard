    ...
    function render_app_dropdown(IntellivoidAccounts $intellivoidAccounts, int $id)
    {
        ...
        if($ApplicationStatus == true)
        {
            ...
            <div class="row ml-auto">
                ...
                <a href="<?PHP DynamicalWeb::getRoute('coa/authentication_requests', array('filter' => 'application_id', 'value' => $id), true) ?>" class="text-white pl-2">
        ...
        else
        {
            ...
            <div class="border-top mt-3 mb-3"></div>
            <div class="row ml-auto">
                <a href="<?PHP DynamicalWeb::getRoute('coa/authentication_requests', array('filter' => 'application_id', 'value' => $id), true) ?>" class="text-white">
                    <i class="mdi mdi-filter"></i>
                </a>
            </div>
            <?PHP
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu p-3">
                                                                            ...
                                                                            <div class="row ml-auto">
                                                                                ...
                                                                                <a href="<?PHP DynamicalWeb::getRoute('coa/authentication_requests', array('filter' => 'host_id', 'value' => $authentication_request['host_id']), true) ?>" class="text-white pl-2">
                                                                                    <i class="mdi mdi-filter"></i>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('coa/view_authentication_request', array('id' => $authentication_request['id']), true); ?>">View Details</a>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('cloud/manage_application', array('id' => $authentication_request['application_id']), true); ?>">Manage Application</a>
                                                                            <?PHP
                                                                            if($authentication_request['account_id'] > 0)
                                                                            {
                                                                                ?>
                                                                                <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('cloud/manage_account', array('id' => $authentication_request['account_id']), true); ?>">Manage Account</a>
                                                                                <?PHP
                                                                            }
                                                                            ?>
                                                                            <div class="dropdown-divider"></div>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('coa/authentication_requests', array('filter' => 'application_id', 'value' => $authentication_request['application_id']), true) ?>">Filter by Application</a>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('coa/authentication_requests', array('filter' => 'host_id', 'value' => $authentication_request['host_id']), true) ?>">Filter by Host</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <nav>
                                                                    <ul class="pagination flat pagination-success flex-wrap">
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            ?>
                                                                            <li class="page-item">
                                                                                <a class="page-link" href="<?PHP DynamicalWeb::getRoute('coa/authentication_requests', $RedirectHref, true); ?>">
                                                                                    <i class="mdi mdi-chevron-left"></i>
                                                                                </a>
                                                                            </li>
                                                                            <?PHP
                                                                        ...
                                                                        while(True)
                                                                        {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                ?>
                                                                                <li class="page-item">
                                                                                    <a class="page-link" href="<?PHP DynamicalWeb::getRoute('coa/authentication_requests', $RedirectHref, true); ?>"><?PHP HTML::print($current_count); ?></a>
                                                                                </li>
                                                                                <?PHP
                                                                            }
