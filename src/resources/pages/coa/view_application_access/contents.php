...
<html lang="en">
    <head>
        ...
        <title>Intellivoid Staff - View Application Access (<?PHP HTML::print($ApplicationAccess->ID); ?>)</title>
    </head>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_application', array('id' => $ApplicationAccess->ApplicationID), true); ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_account', array('id' => $ApplicationAccess->AccountID), true); ?>">
