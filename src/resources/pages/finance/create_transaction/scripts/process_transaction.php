...
use IntellivoidAccounts\Exceptions\AccountNotFoundException;
    ...
    function process_transaction()
    {
        ...
        {
            Actions::redirect(DynamicalWeb::getRoute('finance/create_transaction', array('callback' => '100')));
        }
        ...
        {
            Actions::redirect(DynamicalWeb::getRoute('finance/create_transaction', array('callback' => '102')));
        }

        if($Amount == 0)
        {
            Actions::redirect(DynamicalWeb::getRoute('finance/create_transaction', array('callback' => '103')));
        }
        ...
        if($Amount > 0)
        {
            ...
            {
                Actions::redirect(DynamicalWeb::getRoute('finance/create_transaction', array('callback' => '104')));
            }
            ...
            {
                Actions::redirect(DynamicalWeb::getRoute('finance/create_transaction', array('callback' => '101')));
            }
        }
        if($Amount < 0)
        {
            try
            {
                ...
                {
                    Actions::redirect(DynamicalWeb::getRoute('finance/create_transaction', array('callback' => '106')));
                }
            }
            catch (AccountNotFoundException $e)
            {
        ...
        Actions::redirect(DynamicalWeb::getRoute('finance/create_transaction', array('callback' => '105')));
    }