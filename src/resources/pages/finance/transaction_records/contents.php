...
use IntellivoidAccounts\IntellivoidAccounts;
    ...
    $Results = get_results($IntellivoidAccounts->database, 5000, 'finance/transaction_records', 'id',
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu p-3">
                                                                                ...
                                                                                <div class="row ml-auto">
                                                                                    <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_account', array('id' => $transaction_record['account_id']), true) ?>" class="text-white pl-2">
                                                                                        <i class="mdi mdi-database-search"></i>
                                                                                    </a>
                                                                                    <a href="<?PHP DynamicalWeb::getRoute('finance/transaction_records', array('filter' => 'account_id', 'value' => $transaction_record['account_id']), true) ?>" class="text-white pl-2">
                                                                                        <i class="mdi mdi-filter"></i>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <nav>
                                                                    <ul class="pagination flat pagination-success flex-wrap">
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            ?>
                                                                            <li class="page-item">
                                                                                <a class="page-link" href="<?PHP DynamicalWeb::getRoute('finance/transaction_records', $RedirectHref, true); ?>">
                                                                                    <i class="mdi mdi-chevron-left"></i>
                                                                                </a>
                                                                            </li>
                                                                            <?PHP
                                                                        ...
                                                                        while(True)
                                                                        {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                ?>
                                                                                <li class="page-item">
                                                                                    <a class="page-link" href="<?PHP DynamicalWeb::getRoute('finance/transaction_records', $RedirectHref, true); ?>"><?PHP HTML::print($current_count); ?></a>
                                                                                </li>
                                                                                <?PHP
                                                                            }
