<?PHP
    ...
    function render_details(IntellivoidAccounts $IntellivoidAccounts, Account $account)
    {
        ...
        <div class="col-md-12">
            ...
            <div class="form-group row">
                <button type="button" class="btn btn-outline-primary" onclick="location.href='<?PHP DynamicalWeb::getRoute('cloud/manage_account', array('id' => $_GET['id'], 'action' => 'export_data'), true); ?>';">Export Data</button>
            </div>
        </div>
        <?PHP
    }