    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger" value="Enable" onclick="location.href='<?PHP DynamicalWeb::getRoute('cloud/manage_account', array('id' => $_GET['id'], 'action' => 'set_status', 'status' => 'prm'), true); ?>';">Enable</button>
            </div>
        </div>
    </div>
</div>