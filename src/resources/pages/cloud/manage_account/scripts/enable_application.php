...
use IntellivoidAccounts\IntellivoidAccounts;
    ...
    function enable_application(string $application_id)
    {
        ...
        {
            Actions::redirect(DynamicalWeb::getRoute('cloud/manage_account', array('callback' => '123', 'id' => $_GET['id'])));
        }
        catch(Exception $exception)
        {
            Actions::redirect(DynamicalWeb::getRoute('cloud/manage_account', array('callback' => '122', 'id' => $_GET['id'])));
        }
        ...
        try
        {
            ...
            Actions::redirect(DynamicalWeb::getRoute('cloud/manage_account',
