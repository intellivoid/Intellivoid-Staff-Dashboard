<?php
    ...
    function revoke_access(string $access_id)
    {
        ...
        {
            Actions::redirect(DynamicalWeb::getRoute('cloud/manage_account', array('callback' => '118', 'id' => $_GET['id'])));
        }
        catch(Exception $exception)
        {
            Actions::redirect(DynamicalWeb::getRoute('cloud/manage_account', array('callback' => '119', 'id' => $_GET['id'])));
        }
        ...
        if($ApplicationAccess->Status == ApplicationAccessStatus::Authorized)
        {
            ...
            Actions::redirect(DynamicalWeb::getRoute('cloud/manage_account', array('callback' => '120', 'id' => $_GET['id'])));
        }

        Actions::redirect(DynamicalWeb::getRoute('cloud/manage_account', array('callback' => '121', 'id' => $_GET['id'])));
    }
