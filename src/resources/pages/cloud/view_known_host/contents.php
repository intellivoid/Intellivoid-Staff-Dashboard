...
use IntellivoidAccounts\IntellivoidAccounts;
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('cloud/known_hosts'));
    }
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('cloud/known_hosts', array('callback' => '104')));
    }
    catch(Exception $exception)
    {
        Actions::redirect(DynamicalWeb::getRoute('cloud/known_hosts', array('callback' => '105')));
    }
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?PHP
                                                                        if($KnownHost->Blocked == 1)
                                                                        {
                                                                            HTML::print(" (Blocked)");
                                                                            ?>
                                                                            <a class="ml-2" href="<?PHP DynamicalWeb::getRoute('cloud/view_known_host', array('id' => $_GET['id'], 'action' => 'unblock_host'), true); ?>"> Unblock</a>
                                                                            <?PHP
                                                                        }
                                                                        else
                                                                        {
                                                                            ...
                                                                            ?>
                                                                            <a class="ml-2" href="<?PHP DynamicalWeb::getRoute('cloud/view_known_host', array('id' => $_GET['id'], 'action' => 'block_host'), true); ?>"> Block</a>
                                                                            <?PHP
                                                                        }
                                                                    ?>
                                                                </td>
