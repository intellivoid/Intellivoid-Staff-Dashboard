                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu p-3">
                                                                            ...
                                                                            <div class="row ml-auto">
                                                                                <a href="<?PHP DynamicalWeb::getRoute('cloud/devices', array('filter' => 'platform', 'value' => $device['platform']), true) ?>" class="text-white pl-2">
                                                                                    <i class="mdi mdi-filter"></i>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu p-3">
                                                                            ...
                                                                            <div class="border-top mt-3 mb-3"></div>
                                                                            <div class="row ml-auto">
                                                                                <a href="<?PHP DynamicalWeb::getRoute('cloud/devices', array('filter' => 'browser', 'value' => $device['browser']), true) ?>" class="text-white pl-2">
                                                                                    <i class="mdi mdi-filter"></i>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu p-3">
                                                                            ...
                                                                            <div class="border-top mt-3 mb-3"></div>
                                                                            <div class="row ml-auto">
                                                                                <a href="<?PHP DynamicalWeb::getRoute('cloud/devices', array('filter' => 'host_id', 'value' => $device['host_id']), true) ?>" class="text-white pl-2">
                                                                ...
                                                                <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('cloud/view_device', array('id' => $device['id']), true); ?>">View Details</a>
                                                                            <div class="dropdown-divider"></div>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('cloud/devices', array('filter' => 'platform', 'value' => $device['platform']), true) ?>">Filter by Platform</a>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('cloud/devices', array('filter' => 'browser', 'value' => $device['browser']), true) ?>">Filter by Browser</a>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('cloud/devices', array('filter' => 'host_id', 'value' => $device['host_id']), true) ?>">Filter by Host ID</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <nav>
                                                                    <ul class="pagination flat pagination-success flex-wrap">
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            ?>
                                                                            <li class="page-item">
                                                                                <a class="page-link" href="<?PHP DynamicalWeb::getRoute('cloud/devices', $RedirectHref, true); ?>">
                                                                                    <i class="mdi mdi-chevron-left"></i>
                                                                                </a>
                                                                            </li>
                                                                            <?PHP
                                                                        ...
                                                                        while(True)
                                                                        {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                ?>
                                                                                <li class="page-item">
                                                                                    <a class="page-link" href="<?PHP DynamicalWeb::getRoute('cloud/devices', $RedirectHref, true); ?>"><?PHP HTML::print($current_count); ?></a>
                                                                                </li>
                                                                                <?PHP
                                                                            }
