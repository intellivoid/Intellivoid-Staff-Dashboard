...
use IntellivoidAccounts\IntellivoidAccounts;
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('telegram_clients'));
    }
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('telegram_clients', array('callback' => '104')));
    }
    catch(Exception $exception)
    {
        Actions::redirect(DynamicalWeb::getRoute('telegram_clients', array('callback' => '105')));
    }
?>
<!DOCTYPE html>
<html lang="en">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?PHP DynamicalWeb::getRoute('manage_account', array('id' => $TelegramClient->AccountID), true); ?>">
