...
<div class="modal fade" id="searchDialog" tabindex="-1" role="dialog" aria-labelledby="searchDialogLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" action="<?PHP DynamicalWeb::getRoute('tpa/telegram_clients', array('action' => 'search'), true); ?>">
                <div class="modal-header">
                    <h5 class="modal-title" id="searchDialog">Telegram Clients Search</h5>
