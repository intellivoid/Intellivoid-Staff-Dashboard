...
use msqg\QueryBuilder;
    ...
    $Results = get_results($IntellivoidAccounts->database, 5000, 'authentication_requests', 'id',
        QueryBuilder::select('authentication_requests', ['id', 'request_token', 'application_id', 'account_id', 'host_id', 'requested_permissions', 'status', 'created_timestamp', 'expires_timestamp'], $where, $where_value),
    $where, $where_value);
