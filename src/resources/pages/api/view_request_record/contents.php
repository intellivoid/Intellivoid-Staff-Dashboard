                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('api/view_access_record', array('id' => $RequestRecord->AccessRecordID), true); ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_application', array('id' => $RequestRecord->ApplicationID), true); ?>">
