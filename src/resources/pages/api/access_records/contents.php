                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu p-3">
                                                                            ...
                                                                            <div class="row ml-auto">
                                                                                <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_application', array('id' => $accessRecordObject->ApplicationID), true) ?>" class="text-white pl-2">
                                                                                    <i class="mdi mdi-database-search"></i>
                                                                                </a>
                                                                                <a href="<?PHP DynamicalWeb::getRoute('api/access_records', array('filter' => 'application_id', 'value' => $accessRecordObject->ApplicationID), true) ?>" class="text-white pl-2">
                                                                                    <i class="mdi mdi-filter"></i>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu p-3">
                                                                            ...
                                                                            <div class="row ml-auto">
                                                                                ...
                                                                                <a href="<?PHP DynamicalWeb::getRoute('api/access_records', array('filter' => 'subscription_id', 'value' => $accessRecordObject->SubscriptionID), true) ?>" class="text-white pl-2">
                                                                                    <i class="mdi mdi-filter"></i>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <td style="padding-top: 10px; padding-bottom: 10px;">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('api/view_access_record', array('id' => $accessRecordObject->ID), true); ?>">View Details</a>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('cloud/manage_application', array('id' => $accessRecordObject->ApplicationID), true); ?>">View Application</a>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('request_records', array('filter' => 'access_record_id', 'value' => $accessRecordObject->ID), true) ?>">View Request History</a>
                                                                            <div class="dropdown-divider"></div>
                                                                            <a class="dropdown-item" href="<?PHP DynamicalWeb::getRoute('api/access_records', array('filter' => 'application_id', 'value' => $accessRecordObject->ApplicationID), true); ?>">Filter by Application ID</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <nav>
                                                                    <ul class="pagination flat pagination-success flex-wrap">
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            ?>
                                                                            <li class="page-item">
                                                                                <a class="page-link" href="<?PHP DynamicalWeb::getRoute('api/access_records', $RedirectHref, true); ?>">
                                                                                    <i class="mdi mdi-chevron-left"></i>
                                                                                </a>
                                                                            </li>
                                                                            <?PHP
                                                                        ...
                                                                        while(True)
                                                                        {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                ?>
                                                                                <li class="page-item">
                                                                                    <a class="page-link" href="<?PHP DynamicalWeb::getRoute('api/access_records', $RedirectHref, true); ?>"><?PHP HTML::print($current_count); ?></a>
                                                                                </li>
                                                                                <?PHP
                                                                            }
