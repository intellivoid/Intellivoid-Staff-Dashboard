...
use IntellivoidAPI\IntellivoidAPI;
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('api/access_records'));
    }
    ...
    {
        Actions::redirect(DynamicalWeb::getRoute('api/access_records', array('callback' => '104')));
    }
    catch(Exception $exception)
    {
        Actions::redirect(DynamicalWeb::getRoute('api/access_records', array('callback' => '105')));
    }
?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('cloud/manage_application', array('id' => $AccessRecord->ApplicationID), true); ?>">
