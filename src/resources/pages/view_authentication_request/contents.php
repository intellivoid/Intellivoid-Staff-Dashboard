                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $AuthenticationRequest->ApplicationId), true); ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('manage_account', array('id' => $AuthenticationRequest->AccountId), true); ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?PHP DynamicalWeb::getRoute('manage_application', array('id' => $AuthenticationRequest->HostId), true); ?>">
